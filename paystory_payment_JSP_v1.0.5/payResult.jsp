...
String hashStr 			= sha256Enc.encrypt(mid + ediDate + goodsAmt + merchantKey);	// Hash 값
...
String sGoodsNm  	= ""; String sGoodsAmt		= ""; 	String sTid 		= ""; 
String sName		= ""; String sCpNm		= "";	String sQuota		= "";
String sHashString  = "";
...
if( "0000".equals(resultCode)) {
	...
	*/
	...
	requestData.append("hashStr=").append(hashStr).append("&");
	...
	*/
	...
	sGoodsAmt 		= (String)resultData.get("goodsAmt"); 		// 결제금액
	sTid 			= (String)resultData.get("tid"); 		// 거래ID
	sName			= (String)resultData.get("ordNm");		// 고객명
	sGoodsNm		= (String)resultData.get("goodsNm");	// 상품명
	sCpNm			= (String)resultData.get("cpNm");		// 카드번호
