...
String sAppNo		= "";		// 승인번호
String sOrdNo		= "";		// 주문번호
String sGoodsNm 	= "";		// 결제 상품명
String sGoodsAmt	= "";		// 결제금액
String sOrdNm 		= "";		// 구매자 
String sCpNm 		= "";		// 제휴사명
...
sGoodsNm	= request.getParameter("goodsNm");
sGoodsAmt	= request.getParameter("goodsAmt");
sOrdNm		= request.getParameter("ordNm");
sCpNm		= request.getParameter("cpNm");
