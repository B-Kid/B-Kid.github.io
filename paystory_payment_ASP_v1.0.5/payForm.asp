...
ordNo 			= ""				 				' 상품주문번호	
returnUrl 		= "https://test.com/payResult.jsp"  ' 인증결과 리턴페이지(모바일 결제시 필수)
...
'*/
	...
	hashStr = enc(merchantID & ediDate & goodsAmt & merchantKey)
...
<form name="payInit" method="post" id="payInit" action="./payResult.asp">
	...
	<!-- <input type="hidden" name="notiUrl" value="https://상점도메인/payNoti.asp">--><!-- 결제결과를 따로 통보 받고자 할 때 사용 (가상계좌 사용시 필수)-->
...
>>>>>>> ca039d757d9fa097336c8026b554c962a495d17a
</html>